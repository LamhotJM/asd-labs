...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        for (Component component : visitor.getComponents()) {
            System.out.println(component);
        }
//        visitor.getComponents().forEach(component -> System.out.println(component.toString()));
//        System.out.println(visitor.getComponents());
    }
}
